      ...
      teams: [
        {
          ...
          bullets: [
            ...
            "Served as regional SME for frontend architecture, establishing React/TypeScript best practices adopted across three global product teams.",
            "Transformed position matching from a legacy T+1 batch process to a real-time event-driven architecture using Kafka Streams, cutting latency from 40 min to <5 min for 50M daily transactions.",
            "Engineered a fault-tolerant reconciliation service handling 10k peak events/second with 99.99% data consistency across distributed ledgers.",
      ...
      teams: [
        {
          ...
          bullets: [
            ...
            "担任 SLC 办公室前端架构区域主题专家，制定可扩展的 React/TypeScript 最佳实践，并在三个全球产品团队中推广落地。",
            "将持仓匹配引擎从传统 T+1 批处理改造为基于 Kafka Streams 的实时事件驱动架构，将 5000 万日交易的数据处理延迟从 40 分钟降至 5 分钟以内。",
            "构建容错对账服务，峰值处理能力达每秒 1 万事件，确保分布式账本间 99.99% 的数据一致性，满足监管合规要求。",
        ...
        },
        {
          ...
          bullets: [
            ...
            "构建瑞士市场场外交易产品的核心技术基础设施，开发每日可处理 1000 万笔交易的高吞吐量交易处理器。",
