      ...
      teams: [
        {
          ...
          bullets: [
            ...
            "Served as regional SME for frontend architecture, establishing Application Layer best practices (Full Stack) adopted across three global product teams.",
      ...
      teams: [
        {
          ...
          bullets: [
            ...
            "担任 SLC 办公室前端架构区域 SME，制定可扩展的用户端（Application）Layer 最佳实践（Full Stack），并在三个全球产品团队中推广落地。",
